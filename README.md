...
<html b:dynamicViews='true' b:version='2' class='v2' expr:dir='data:blog.languageDirection' expr:lang='data:blog.locale' xmlns='http://www.w3.org/1999/xhtml' xmlns:b='http://www.google.com/2005/gml/b' xmlns:data='http://www.google.com/2005/gml/data' xmlns:expr='http://www.google.com/2005/gml/expr'>
  <head>
    ...
    <meta content='!' name='kerala to kashmir'/>
    <meta content='dynamic' name='blogger-template'/>
    <meta content='IE=9,chrome=1' http-equiv='X-UA-Compatible'/>
    <meta content='initial-scale=1.0, maximum-scale=1.0, user-scalable=yes, width=device-width' name='viewport'/>
    <meta content='Kerala to kashmir, tour packages, lock your trip, book kerala to kashmir tour' name='keywords'/>
    <meta content='At Lock Your Trip, we take pride in curating unforgettable travel experiences from Kerala to Kashmir, enchanting the beauty of Kashmir' name='description'/>
    <b:skin><![CDATA[/*-----------------------------------------------
Blogger Template Style
Name: kerala to kashmir
----------------------------------------------- */
...
/* Variable definitions
   ...
   <Variable name="body.background" description="Body Background" type="background"
       color="#EEEEEE" default="$(color) none repeat scroll top left" value="$(color) url(https://blogger.googleusercontent.com/img/a/AVvXsEhaoHmIFy1vVDTtPPLGQ7ZWv0wuoHWPduz6oIFmpVDGoO5XMpoNBEIE1mAjC-9uL5a9zM0X5CzDjYvmRENIja8ao-I-E3mqI6uITPB-Rr0fUKToCfhNB-18ScCmK4_0tltLaY8Hxjaz81AKZWfv3sG0P_bMVcKvvRpEfWikn245g2sN9tMqXeIxaDrt6TU=s1600) repeat scroll top left"/>
   ...
   <Variable name="blitzview" description="Initial view type" type="string" default="sidebar" value="magazine"/>
*/
                        ...
                        <div class='column-right-inner'>
                          <aside>
                            <b:section class='sidebar' id='sidebar-right-1' preferred='yes' showaddelement='yes'>
                              <b:widget id='Header1' locked='false' title='KeralaTour packages  (Header)' type='Header'>
                                <b:widget-settings>
  ...
  <b:tag cond='data:blog.url != data:blog.homepageUrl' expr:href='data:blog.homepageUrl' name='a'>
    <data:title/>
                              ...
                              <b:widget id='PageList1' locked='false' title='' type='PageList'>
                                <b:widget-settings>
                                  <b:widget-setting name='pageListJson'><![CDATA[{"home":{"href":"http://keralatokashmir.blogspot.com/","position":0,"title":"Home"}}]]></b:widget-setting>
